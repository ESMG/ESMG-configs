...
#       csa = m.contour(x, y, aice, levels=levels, linewidths=(0.5,))
        cs = plt.contourf(clon, clat, aice, levels=levels, cmap=cmap)
        plt.title('Surface Elevation')
#       csa = plt.contour(clon, clat, aice, levels=levels, linewidths=(0.5,))
