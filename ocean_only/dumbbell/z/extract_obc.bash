...
ncks -d xh,41,41 -v v -A  prog_late.nc west.nc
...
ncks -d xh,41,41 -v h -A  prog_late.nc west.nc
ncrename -v h,dz_v_segment_001 west.nc
...
ncks -d xh,82,82 -v v -A  prog_late.nc east.nc
...
ncks -d xh,82,82 -v h -A  prog_late.nc east.nc
ncrename -v h,dz_v_segment_002 east.nc
