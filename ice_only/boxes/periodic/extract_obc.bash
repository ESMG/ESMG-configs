...
ncks -d xT,4,4 -d yB,5,15 -v vice -A  10000101.daily.nc west.nc
...
ncrename -v hice,hi_segment_001 west.nc
...
ncks -d xT,15,15 -d yB,5,15 -v vice -A  10000101.daily.nc east.nc
...
# North
ncks -O -d xB,5,15 -d yT,15,15 -v uice 10000101.daily.nc north.nc
ncks -d xT,5,14 -d yB,15,15 -v vice -A  10000101.daily.nc north.nc
...
# South
ncks -O -d xB,5,15 -d yT,5,5 -v uice 10000101.daily.nc south.nc
ncks -d xT,5,14 -d yB,4,4 -v vice -A  10000101.daily.nc south.nc
